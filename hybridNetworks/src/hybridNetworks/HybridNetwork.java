...
public class HybridNetwork {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("Id : Priority : CurrentAllocatedRequest : MaxRequireRequest : DurationRequest : StartDate");
		...
		for (int i = 0; i < Constants.SIMULATION_TIME; i++) {
			...
			/**
			 * 1. Assign all nodes to particular subscriber stations by checking
			 * the nearest possible subscriber station
			 */

			/**
			 * 2. get all relevant requests for the current time 3. Check to
			 * which node the request belong, assign the node object to the
			 * request. 4. Check under which subscriber station the requests
			 * belong
			 */

			/**
			 * 5. Allot all requests under a subscriber station to priority
			 * queues of subscriber station 6. Run the scheduling function of
			 * each subscriber station 7. Append the resulting array of requests
			 * to array of corresponding base station 8. After All subscriber
			 * stations are dealt with, run the scheduling function of base
			 * station
			 */

			/**
			 * 9. After running Scheduling function of Base Station, Record a
