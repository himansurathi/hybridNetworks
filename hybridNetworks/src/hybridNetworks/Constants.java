...
public class Constants {
	...
	static final String BS_FILE="/input/baseStations.txt"; //Base Station Input File
	static final String SS_FILE="/input/subscriberStations.txt"; //Subscriber Station Input File
	static final String NODE_FILE="/input/nodes.txt"; //Node Input File Name
	static final String REQUEST_FILE="/input/requests.txt";//Request Input File Name
